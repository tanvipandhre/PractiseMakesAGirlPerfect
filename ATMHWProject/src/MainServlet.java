 ...
 */
/**
 * @author Tanvi Pandhre UCID - tp356
 *
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Connection conn = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/ATM?useUnicode=true&characterEncoding=utf8", "root", "rootroot");
			if (conn != null) {
			...
			if (request.getParameter("amount") == null) {
				...
				if (isAuthUser) {
					...
					if (request.getParameter("amount") != null || !request.getParameter("amount").isEmpty()) {
						...
						String updateQuery = "update accountInfo set balance = '" + currentBalance + "' where userID ='"
								+ userID + "' ";
